...
namespace KRG
{
    ...
    namespace TypeSystem
    {
        ...
        {
            template<>
            class KRG_ENGINE_RENDER_API TTypeHelper<KRG::Render::MeshComponent> : public ITypeHelper
            {
            ...
            public:
                ...
                static void RegisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    ...
                    typeInfo.RegisterProperties< KRG::TypeSystem::TypeHelpers::TTypeHelper<KRG::Render::MeshComponent> >( DefaultTypeInstancePtr );
                    KRG::Render::MeshComponent::StaticTypeInfo = typeRegistry.RegisterType( typeInfo );
                }
