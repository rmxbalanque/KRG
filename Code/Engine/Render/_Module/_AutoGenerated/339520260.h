...
#include "E:\Git\KRG\Code\Engine\Render\Components\SkeletalMeshComponent.h"
...
namespace KRG
{
    ...
    {
        template<>
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Render::SkeletalMeshComponent> >( IRegisteredType const* pDefaultTypeInstance )
        {
        ...
        namespace TypeHelpers
        {
            ...
            public:
                ...
                static void RegisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    ...
                    pDefaultTypeInstance = (IRegisteredType*) KRG::Alloc( sizeof( KRG::Render::SkeletalMeshComponent ), alignof( KRG::Render::SkeletalMeshComponent ) );
