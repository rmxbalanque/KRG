...
#include "E:\Git\KRG\Code\Engine\Render\_Module\_AutoGenerated\339520260.h"
...
namespace KRG
{
    ...
    namespace TypeSystem
    {
        ...
        {
            IRegisteredType const* TTypeHelper<KRG::Render::SkeletalMeshComponent>::s_pDefaultTypeInstancePtr = nullptr;
