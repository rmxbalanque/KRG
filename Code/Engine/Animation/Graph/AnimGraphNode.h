...
namespace KRG::Animation::Graph
{
    ...
    public:
        ...
        virtual void OnConstruct( Settings const* pSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet );
    ...
    public:
        ...
        void Initialize( GraphContext& context, SyncTrackTime const& initialTime );
