...
namespace KRG::Animation::Graph
{
    ...
    void GraphContext::Initialize( TaskSystem* pTaskSystem, GraphDataSet const* pDataSet, Pose const* pPreviousPose )
    {
        ...
        const_cast<GraphDataSet const*&>( m_pDataSet ) = pDataSet;
    ...
    void GraphContext::Shutdown()
    {
        ...
        const_cast<GraphDataSet const*&>( m_pDataSet ) = nullptr;
