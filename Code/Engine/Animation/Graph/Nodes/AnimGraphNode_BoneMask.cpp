#include "AnimGraphNode_BoneMask.h"
...
namespace KRG::Animation::Graph
{
    ...
    void BoneMaskBlendNode::OnConstruct( GraphNode::Settings const* pSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
    ...
    void BoneMaskSelectorNode::OnConstruct( GraphNode::Settings const* pSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
        ValueNodeBoneMask::OnConstruct( pSettings, nodePtrs, dataSet );
