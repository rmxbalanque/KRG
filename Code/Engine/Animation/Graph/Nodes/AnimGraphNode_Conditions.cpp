#include "AnimGraphNode_Conditions.h"

//-------------------------------------------------------------------------

namespace KRG::Animation::Graph
{
    void AndNode::OnConstruct( GraphNode::Settings const* pSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
    ...
    void OrNode::OnConstruct( GraphNode::Settings const* pSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
        ValueNodeBool::OnConstruct( pSettings, nodePtrs, dataSet );
    ...
    void NotNode::OnConstruct( GraphNode::Settings const* pInSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
    ...
    void FloatComparisonNode::OnConstruct( GraphNode::Settings const* pInSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
        ValueNodeBool::OnConstruct( pInSettings, nodePtrs, dataSet );
    ...
    void RangeComparisonNode::OnConstruct( GraphNode::Settings const* pInSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
        ValueNodeBool::OnConstruct( pInSettings, nodePtrs, dataSet );
    ...
    void IDComparisonNode::OnConstruct( GraphNode::Settings const* pInSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
        ValueNodeBool::OnConstruct( pInSettings, nodePtrs, dataSet );
    ...
    void MultipleIDComparisonNode::OnConstruct( GraphNode::Settings const* pInSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
        ValueNodeBool::OnConstruct( pInSettings, nodePtrs, dataSet );
    ...
    void IsTargetSetNode::OnConstruct( GraphNode::Settings const* pInSettings, TVector<GraphNode*> const& nodePtrs, GraphDataSet const& dataSet )
    {
        ValueNodeBool::OnConstruct( pInSettings, nodePtrs, dataSet );
