#include "AnimGraphTask_Blend.h"

//-------------------------------------------------------------------------

namespace KRG::Animation::Graph::Tasks
{
    BlendTask::BlendTask( int16 sourceNodeIdx, int8 sourceTaskIdx, int8 targetTaskIdx, float const blendWeight, TBitFlags<PoseBlendOptions> blendOptions, BoneMask const* pBoneMask )
