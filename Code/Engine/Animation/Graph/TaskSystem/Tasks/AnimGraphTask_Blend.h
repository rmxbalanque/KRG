...
namespace KRG::Animation::Graph::Tasks
{
    ...
    public:
        ...
        BlendTask( int16 sourceNodeIdx, int8 sourceTaskIdx, int8 targetTaskIdx, float const blendWeight, TBitFlags<PoseBlendOptions> const blendOptions, BoneMask const* pBoneMask = nullptr );
