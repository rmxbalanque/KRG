#include "AnimGraphTask_CachedPose.h"

//-------------------------------------------------------------------------

namespace KRG::Animation::Graph::Tasks
{
    CachedPoseWriteTask::CachedPoseWriteTask( int16 sourceNodeIdx, int8 sourceTaskIdx, UUID cachedPoseID )
    ...
    CachedPoseReadTask::CachedPoseReadTask( int16 sourceNodeIdx, UUID cachedPoseID )
        : Task( sourceNodeIdx )
        , m_cachedPoseID( cachedPoseID )
    {
        KRG_ASSERT( m_cachedPoseID.IsValid() );
