#include "AnimGraphTaskSystem.h"
#include "Engine/Animation/AnimationBlender.h"
#include "System/Core/Logging/Log.h"
#include "Tasks/AnimGraphTask_DefaultPose.h"
...
namespace KRG::Animation::Graph
{
    ...
    void TaskSystem::RollbackToMarker( TaskMarker const marker )
    {
    ...
    bool TaskSystem::AddTaskChainToPrePhysicsList( int8 taskIdx )
    {
    ...
    void TaskSystem::UpdatePrePhysics( float deltaTime, Transform const& worldTransform, Transform const& worldTransformInverse )
    {
        ...
        if ( m_hasPhysicsDependency )
        {
            ...
            int8 const numTasks = (int8) m_tasks.size();
            for ( int8 i = 0; i < numTasks; i++ )
            {
            ...
            {
                for ( int8 prePhysicsTaskIdx : m_prePhysicsTaskIndices )
                {
                    // Set dependencies
