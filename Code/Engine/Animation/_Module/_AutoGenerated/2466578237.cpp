...
namespace KRG
{
    namespace TypeSystem
    {
        ...
        {
            void EnumHelper_KRG_Animation_Event_AllowedTypes::RegisterEnum( TypeSystem::TypeRegistry& typeRegistry )
            {
                TypeSystem::TypeInfo typeInfo;
                typeInfo.m_ID = TypeSystem::TypeID( "KRG::Animation::Event::AllowedTypes" );
                typeInfo.m_size = sizeof( KRG::Animation::Event::AllowedTypes );
                typeInfo.m_alignment = alignof( KRG::Animation::Event::AllowedTypes );
                typeRegistry.RegisterType( typeInfo );

                TypeSystem::EnumInfo enumInfo;
                enumInfo.m_ID = TypeSystem::TypeID( "KRG::Animation::Event::AllowedTypes" );
            ...
            void EnumHelper_KRG_Animation_Event_AllowedTypes::UnregisterEnum( TypeSystem::TypeRegistry& typeRegistry )
            {
                auto const ID = TypeSystem::TypeID( "KRG::Animation::Event::AllowedTypes" );
