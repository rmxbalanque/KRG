...
#include "E:\Git\KRG\Code\Engine\Animation\Components\AnimationComponent.h"
...
namespace KRG
{
    ...
    {
        template<>
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::AnimationComponent> >( IRegisteredType const* pDefaultTypeInstance )
        {
