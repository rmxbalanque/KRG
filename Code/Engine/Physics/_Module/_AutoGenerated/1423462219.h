...
namespace KRG
{
    ...
    {
        archive( cereal::base_class<KRG::SpatialEntityComponent>( &type ), KRG_NVP( m_transform ), KRG_NVP( m_pPhysicsMaterial ), KRG_NVP( m_actorType ), KRG_NVP( m_shapeType ) );
    }
    ...
    namespace TypeSystem
    {
        ...
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Physics::PhysicsComponent> >( void const* pDefaultTypeInstance )
        {
            ...
            propertyInfo.m_pDefaultValue = nullptr;
            propertyInfo.m_offset = offsetof( KRG::Physics::PhysicsComponent, m_pPhysicsMaterial );
