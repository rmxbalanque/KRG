...
namespace KRG::Player
{
    ...
    DevelopmentPlayerController::DevelopmentPlayerController()
    ...
    void DevelopmentPlayerController::RegisterComponent( EntityComponent* pComponent )
    {
    ...
    void DevelopmentPlayerController::UnregisterComponent( EntityComponent* pComponent )
    {
        if ( auto pSpatialComponent = TryCast<SpatialEntityComponent>( pComponent ) )
        {
    ...
    void DevelopmentPlayerController::Update( EntityUpdateContext const& ctx )
    {
