...
#include "E:\Git\KRG\Code\Game\Core\Test\CustomizerTestSystem.h"
...
namespace KRG
{
    ...
    {
        template<>
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::CustomizerTestSystem> >( IRegisteredType const* pDefaultTypeInstance )
        {
        ...
        namespace TypeHelpers
        {
            ...
            public:
                ...
                static void RegisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    ...
                    pDefaultTypeInstance = (IRegisteredType*) KRG::Alloc( sizeof( KRG::CustomizerTestSystem ), alignof( KRG::CustomizerTestSystem ) );
