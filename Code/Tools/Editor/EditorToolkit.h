...
namespace KRG
{
    ...
    class KRG_TOOLS_EDITOR_API EditorToolkit : public ImGuiX::DevelopmentTools
    {
    ...
    class KRG_TOOLS_EDITOR_API EditorToolkitFactory
    {
    ...
    class KRG_TOOLS_EDITOR_API EditorToolkitRegistry
    {
    public:
