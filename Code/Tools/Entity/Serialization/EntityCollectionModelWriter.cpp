...
namespace KRG
{
    namespace EntityModel
    {
        ...
        bool EntityCollectionModelWriter::WriteCollection( TypeSystem::TypeRegistry const& typeRegistry, FileSystem::Path const& outFilePath, EntityCollectionDescriptor const& collection )
        {
