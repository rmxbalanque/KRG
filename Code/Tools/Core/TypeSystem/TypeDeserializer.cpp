...
namespace KRG
{
    namespace Serialization
    {
        namespace
        {
            ...
            static void ReadCoreType( TypeSystem::TypeID const& typeID, Value const& typeValue, void* pPropertyDataAddress )
            {
        ...
        TypeDeserializer::TypeDeserializer( TypeSystem::TypeRegistry const& typeRegistry )
        ...
        bool TypeDeserializer::ReadFromFile( FileSystemPath const& filePath )
        {
        ...
        rapidjson::Value const& TypeDeserializer::GetValueToBeDeserialized() const
        {
        ...
        void TypeDeserializer::DeserializeType( rapidjson::Value const& currentJsonValue, TypeSystem::TypeID typeID, void* pTypeData ) const
        {
