...
namespace KRG
{
    class KRG_TOOLS_CORE_API DataBrowserTreeItem : public TreeViewItem
    {
    public:
    ...
    class KRG_TOOLS_CORE_API DataBrowserTreeView : public TreeView, public FileSystem::IFileSystemChangeListener
    {
