...
{
    class LayerNode final : public FlowToolsNode
    {
        KRG_REGISTER_TYPE( LayerNode );
    ...
    {
        KRG_REGISTER_TYPE( LayerToolsNode );
    ...
    private:
        ...
        virtual uint32 GetDynamicInputPinValueType() const override { return (uint32) NodeValueType::Unknown; }
