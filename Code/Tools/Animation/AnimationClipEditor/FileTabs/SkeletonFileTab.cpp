...
{
    SkeletonFileTab::~SkeletonFileTab()
    {
        DestroySkeletonTree();
    ...
    void SkeletonFileTab::CreateSkeletonTree()
    {
    ...
    void SkeletonFileTab::DestroySkeletonTree()
    {
        if ( m_pSkeletonTreeRoot != nullptr )
        {
    ...
    ImRect SkeletonFileTab::RenderSkeletonTree( BoneInfo* pBone ) const
    {
