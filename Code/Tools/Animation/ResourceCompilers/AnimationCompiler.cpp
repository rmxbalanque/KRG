...
namespace KRG::Animation
{
    ...
    void AnimationCompiler::SetRootMotionData( RawAssets::RawAnimation const& rawAnimData, AnimationClip& animClip ) const
    {
    ...
    bool AnimationCompiler::CreateEventsData( Resource::CompileContext const& ctx, AnimationResourceDescriptor const& animResourceDesc, RawAssets::RawAnimation const& rawAnimData, AnimationEventData& outEventData ) const
    {
        // Events are optional
