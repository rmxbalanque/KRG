...
#include "E:\Git\KRG\Code\Tools\Animation\ResourceDescriptors\ResourceDescriptor_AnimationClip.h"
...
namespace KRG
{
    ...
    {
        archive( cereal::base_class<KRG::Resource::ResourceDescriptor>( &type ), KRG_NVP( m_animationPath ), KRG_NVP( m_pSkeleton ), KRG_NVP( m_animationName ) );
    }
    ...
    namespace TypeSystem
    {
        ...
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::AnimationClipResourceDescriptor> >( IRegisteredType const* pDefaultTypeInstance )
        {
            ...
            propertyInfo.m_ID = StringID( "m_animationPath" );
            propertyInfo.m_typeID = TypeSystem::TypeID( "KRG::ResourcePath" );
            propertyInfo.m_parentTypeID = 272179067;
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_animationPath;
            propertyInfo.m_offset = offsetof( KRG::Animation::AnimationClipResourceDescriptor, m_animationPath );
        ...
        namespace TypeHelpers
        {
            ...
            public:
                ...
                virtual bool AreAllPropertyValuesEqual( IRegisteredType const* pTypeInstance, IRegisteredType const* pOtherTypeInstance ) const override final
                {
                    ...
                    if( !pTypeHelper->IsPropertyValueEqual( pType, pOtherType, 1577586573 ) )
                    {
                       return false;
                    }
                ...
                virtual bool IsPropertyValueEqual( IRegisteredType const* pTypeInstance, IRegisteredType const* pOtherTypeInstance, uint32 propertyID, int32 arrayIdx = InvalidIndex ) const override final
                {
                    ...
                    if ( propertyID == 1577586573 )
                    {
                        return pType->m_animationPath == pOtherType->m_animationPath;
                    }
                ...
                virtual void ResetToDefault( IRegisteredType* pTypeInstance, uint32 propertyID ) override final
                {
                    ...
                    if ( propertyID == 1577586573 )
                    {
                        pActualType->m_animationPath = pDefaultType->m_animationPath;
                        return;
                    }
