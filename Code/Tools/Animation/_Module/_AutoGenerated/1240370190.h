...
#include "E:\Git\KRG\Code\Tools\Animation\ResourceDescriptors\ResourceDescriptor_AnimationGraph.h"
...
namespace KRG
{
    ...
    KRG_TOOLS_ANIMATION_API void serialize( Archive& archive, KRG::Animation::AnimationGraphResourceDescriptor& type )
    {
        archive( cereal::base_class<KRG::Resource::ResourceDescriptor>( &type ) );
    }
    ...
    {
        template<>
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::AnimationGraphResourceDescriptor> >( IRegisteredType const* pDefaultTypeInstance )
        {
            KRG_ASSERT( pDefaultTypeInstance != nullptr );
            KRG::Animation::AnimationGraphResourceDescriptor const* pActualDefaultTypeInstance = ( KRG::Animation::AnimationGraphResourceDescriptor const* ) pDefaultTypeInstance;
        ...
        {
            template<>
            class KRG_TOOLS_ANIMATION_API TTypeHelper<KRG::Animation::AnimationGraphResourceDescriptor> final : public ITypeHelper
            {
                static TTypeHelper<KRG::Animation::AnimationGraphResourceDescriptor> StaticTypeHelper;
            ...
            public:
                ...
                static void RegisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    ...
                    pDefaultTypeInstance = (IRegisteredType*) KRG::Alloc( sizeof( KRG::Animation::AnimationGraphResourceDescriptor ), alignof( KRG::Animation::AnimationGraphResourceDescriptor ) );
                    new ( pDefaultTypeInstance ) KRG::Animation::AnimationGraphResourceDescriptor;

                    TypeSystem::TypeInfo typeInfo;
                    typeInfo.m_ID = TypeSystem::TypeID( "KRG::Animation::AnimationGraphResourceDescriptor" );
                    typeInfo.m_size = sizeof( KRG::Animation::AnimationGraphResourceDescriptor );
                    typeInfo.m_alignment = alignof( KRG::Animation::AnimationGraphResourceDescriptor );
                    ...
                    KRG::Animation::AnimationGraphResourceDescriptor::s_pTypeInfo = typeRegistry.RegisterType( typeInfo );
                }

                static void UnregisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    auto const ID = TypeSystem::TypeID( "KRG::Animation::AnimationGraphResourceDescriptor" );
                    typeRegistry.UnregisterType( ID );

                    IRegisteredType*& pDefaultTypeInstance = const_cast<IRegisteredType*&>( s_pDefaultTypeInstancePtr );
                    reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor*>( pDefaultTypeInstance )->~AnimationGraphResourceDescriptor();
                    KRG::Free( pDefaultTypeInstance );
                }

                virtual IRegisteredType* CreateType() const override final
                {
                    return KRG::New<KRG::Animation::AnimationGraphResourceDescriptor>();
                }

                virtual void CreateTypeInPlace( IRegisteredType* pAllocatedMemory ) const override final
                {
                    KRG_ASSERT( pAllocatedMemory != nullptr );
                    new( pAllocatedMemory ) KRG::Animation::AnimationGraphResourceDescriptor();
                }

                virtual void LoadResources( Resource::ResourceSystem* pResourceSystem, UUID const& requesterID, IRegisteredType* pType ) const override final
                {
                    KRG_ASSERT( pResourceSystem != nullptr );
                    auto pActualType = reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor*>( pType );
                ...
                {
                    auto pActualType = reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor const*>( pTypeInstance );
                ...
                {
                    auto pActualType = reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor*>( pTypeInstance );
                ...
                {
                    auto pTypeHelper = KRG::Animation::AnimationGraphResourceDescriptor::s_pTypeInfo->m_pTypeHelper;
                    auto pType = reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor const*>( pTypeInstance );
                    auto pOtherType = reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor const*>( pOtherTypeInstance );
                ...
                {
                    auto pDefaultType = reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor const*>( GetDefaultTypeInstancePtr() );
                    auto pActualType = reinterpret_cast<KRG::Animation::AnimationGraphResourceDescriptor*>( pTypeInstance );
...
namespace KRG
{
    ...
    {
        archive( cereal::base_class<KRG::Resource::ResourceDescriptor>( &type ), KRG_NVP( m_graphPath ), KRG_NVP( m_variationID ) );
    }
    ...
    namespace TypeSystem
    {
        ...
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::AnimationGraphVariationResourceDescriptor> >( IRegisteredType const* pDefaultTypeInstance )
        {
            ...
            propertyInfo.m_ID = StringID( "m_graphPath" );
            propertyInfo.m_typeID = TypeSystem::TypeID( "KRG::ResourcePath" );
            propertyInfo.m_parentTypeID = 1714462230;
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_graphPath;
            propertyInfo.m_offset = offsetof( KRG::Animation::AnimationGraphVariationResourceDescriptor, m_graphPath );
        ...
        namespace TypeHelpers
        {
            ...
            public:
                ...
                virtual bool AreAllPropertyValuesEqual( IRegisteredType const* pTypeInstance, IRegisteredType const* pOtherTypeInstance ) const override final
                {
                    ...
                    if( !pTypeHelper->IsPropertyValueEqual( pType, pOtherType, 1089439247 ) )
                    {
                       return false;
                    }
                ...
                virtual bool IsPropertyValueEqual( IRegisteredType const* pTypeInstance, IRegisteredType const* pOtherTypeInstance, uint32 propertyID, int32 arrayIdx = InvalidIndex ) const override final
                {
                    ...
                    if ( propertyID == 1089439247 )
                    {
                        return pType->m_graphPath == pOtherType->m_graphPath;
                    }
                ...
                virtual void ResetToDefault( IRegisteredType* pTypeInstance, uint32 propertyID ) override final
                {
                    ...
                    if ( propertyID == 1089439247 )
                    {
                        pActualType->m_graphPath = pDefaultType->m_graphPath;
                        return;
                    }
