...
#include "D:\Kruger\Code\Tools\Animation\Graph\Nodes\AnimationToolsNode_AnimationClip.h"
...
namespace KRG
{
    ...
    {
        template<>
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::AnimationClipToolsNode> >( IRegisteredType const* pDefaultTypeInstance )
        {
            ...
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::AnimationClipToolsNode, m_canvasPosition );
            ...
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::AnimationClipToolsNode, m_ID );
            ...
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::AnimationClipToolsNode, m_name );
            ...
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::AnimationClipToolsNode, m_allowLooping );
            propertyInfo.m_size = sizeof( bool );
            propertyInfo.m_flags.Set( 1 );
            m_properties.emplace_back( propertyInfo );
            m_propertyMap.insert( TPair<StringID, int32>( propertyInfo.m_ID, int32( m_properties.size() ) - 1 ) );
        ...
        {
            template<>
            class KRG_TOOLS_ANIMATION_API TTypeHelper<KRG::Animation::Graph::AnimationClipToolsNode> final : public ITypeHelper
            {
                static TTypeHelper<KRG::Animation::Graph::AnimationClipToolsNode> StaticTypeHelper;
            ...
            public:
                ...
                static void RegisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    ...
                    pDefaultTypeInstance = (IRegisteredType*) KRG::Alloc( sizeof( KRG::Animation::Graph::AnimationClipToolsNode ), alignof( KRG::Animation::Graph::AnimationClipToolsNode ) );
                    new ( pDefaultTypeInstance ) KRG::Animation::Graph::AnimationClipToolsNode;

                    TypeSystem::TypeInfo typeInfo;
                    typeInfo.m_ID = TypeSystem::TypeID( "KRG::Animation::Graph::AnimationClipToolsNode" );
                    typeInfo.m_size = sizeof( KRG::Animation::Graph::AnimationClipToolsNode );
                    typeInfo.m_alignment = alignof( KRG::Animation::Graph::AnimationClipToolsNode );
                    ...
                    typeInfo.RegisterProperties< KRG::TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::AnimationClipToolsNode> >( s_pDefaultTypeInstancePtr );
                    KRG::Animation::Graph::AnimationClipToolsNode::s_pTypeInfo = typeRegistry.RegisterType( typeInfo );
                }

                static void UnregisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    auto const ID = TypeSystem::TypeID( "KRG::Animation::Graph::AnimationClipToolsNode" );
                    typeRegistry.UnregisterType( ID );

                    IRegisteredType*& pDefaultTypeInstance = const_cast<IRegisteredType*&>( s_pDefaultTypeInstancePtr );
                    reinterpret_cast<KRG::Animation::Graph::AnimationClipToolsNode*>( pDefaultTypeInstance )->~AnimationClipToolsNode();
                    KRG::Free( pDefaultTypeInstance );
                }

                virtual IRegisteredType* CreateType() const override final
                {
                    return KRG::New<KRG::Animation::Graph::AnimationClipToolsNode>();
                }

                virtual void CreateTypeInPlace( IRegisteredType* pAllocatedMemory ) const override final
                {
                    KRG_ASSERT( pAllocatedMemory != nullptr );
                    new( pAllocatedMemory ) KRG::Animation::Graph::AnimationClipToolsNode();
                }
