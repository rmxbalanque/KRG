...
#include "D:\Kruger\Code\Tools\Animation\_Module\_AutoGenerated\975575515.cpp"
...
void KRG::Animation::ToolsModule::RegisterTypes( TypeSystem::TypeRegistry& typeRegistry )
{
    ...
    TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::ToolsGraph>::RegisterType( typeRegistry );
    ...
    TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::DataSlotNode>::RegisterType( typeRegistry );
    ...
    TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::DataSlotNode::OverrideValue>::RegisterType( typeRegistry );
...
void KRG::Animation::ToolsModule::UnregisterTypes( TypeSystem::TypeRegistry& typeRegistry )
{
    ...
    TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::DataSlotNode::OverrideValue>::UnregisterType( typeRegistry );
    ...
    TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::DataSlotNode>::UnregisterType( typeRegistry );
    ...
    TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::ToolsGraph>::UnregisterType( typeRegistry );
