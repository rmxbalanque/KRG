...
{
    template<class Archive>
    KRG_TOOLS_ANIMATION_API void serialize( Archive& archive, KRG::Animation::Graph::StateBaseToolsNode& type )
    {
    ...
    {
        template<>
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::StateBaseToolsNode> >( IRegisteredType const* pDefaultTypeInstance )
        {
            PropertyInfo propertyInfo;
            ...
            propertyInfo.m_ID = StringID( "m_canvasPosition" );
            propertyInfo.m_typeID = TypeSystem::TypeID( "KRG::Float2" );
            propertyInfo.m_parentTypeID = 3303520242;
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
        ...
        {
            template<>
            class KRG_TOOLS_ANIMATION_API TTypeHelper<KRG::Animation::Graph::StateBaseToolsNode> final : public ITypeHelper
            {
                static TTypeHelper<KRG::Animation::Graph::StateBaseToolsNode> StaticTypeHelper;
            ...
            public:
                ...
                {
                    TypeSystem::TypeInfo typeInfo;
                    typeInfo.m_ID = TypeSystem::TypeID( "KRG::Animation::Graph::StateBaseToolsNode" );
                    typeInfo.m_size = sizeof( KRG::Animation::Graph::StateBaseToolsNode );
                    typeInfo.m_alignment = alignof( KRG::Animation::Graph::StateBaseToolsNode );
                    typeInfo.m_pTypeHelper = &StaticTypeHelper; 
                    ...
                    typeInfo.RegisterProperties< KRG::TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::StateBaseToolsNode> >( s_pDefaultTypeInstancePtr );
                    KRG::Animation::Graph::StateBaseToolsNode::s_pTypeInfo = typeRegistry.RegisterType( typeInfo );
                }

                static void UnregisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    auto const ID = TypeSystem::TypeID( "KRG::Animation::Graph::StateBaseToolsNode" );
                    typeRegistry.UnregisterType( ID );
                ...
                {
                    KRG_ASSERT( pResourceSystem != nullptr );
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::StateBaseToolsNode*>( pType );
                ...
                virtual size_t GetArraySize( IRegisteredType const* pTypeInstance, uint32 arrayID ) const override final
                {
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::StateBaseToolsNode const*>( pTypeInstance );
                ...
                virtual void ClearArray( IRegisteredType* pTypeInstance, uint32 arrayID ) const override final
                {
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::StateBaseToolsNode*>( pTypeInstance );
                ...
                virtual bool AreAllPropertyValuesEqual( IRegisteredType const* pTypeInstance, IRegisteredType const* pOtherTypeInstance ) const override final
                {
                    auto pTypeHelper = KRG::Animation::Graph::StateBaseToolsNode::s_pTypeInfo->m_pTypeHelper;
                    auto pType = reinterpret_cast<KRG::Animation::Graph::StateBaseToolsNode const*>( pTypeInstance );
                    auto pOtherType = reinterpret_cast<KRG::Animation::Graph::StateBaseToolsNode const*>( pOtherTypeInstance );
                ...
                virtual void ResetToDefault( IRegisteredType* pTypeInstance, uint32 propertyID ) override final
                {
                    auto pDefaultType = reinterpret_cast<KRG::Animation::Graph::StateBaseToolsNode const*>( GetDefaultTypeInstancePtr() );
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::StateBaseToolsNode*>( pTypeInstance );
...
namespace KRG
{
    ...
    {
        archive( cereal::base_class<KRG::Animation::Graph::StateBaseToolsNode>( &type ), KRG_NVP( m_entryEvents ), KRG_NVP( m_canvasPosition ), KRG_NVP( m_name ), KRG_NVP( m_exitEvents ), KRG_NVP( m_executeEvents ), KRG_NVP( m_ID ), KRG_NVP( m_timeRemainingEvents ), KRG_NVP( m_timeElapsedEvents ) );
    }
        ...
        namespace TypeHelpers
        {
            ...
            public:
                ...
                static void RegisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    ...
                    pParentType = KRG::Animation::Graph::StateBaseToolsNode::s_pTypeInfo;
                    KRG_ASSERT( pParentType != nullptr );
                    typeInfo.m_parentTypes.push_back( pParentType );
...
{
    template<class Archive>
    KRG_TOOLS_ANIMATION_API void serialize( Archive& archive, KRG::Animation::Graph::OffStateToolsNode& type )
    {
        archive( cereal::base_class<KRG::Animation::Graph::StateBaseToolsNode>( &type ), KRG_NVP( m_entryEvents ), KRG_NVP( m_canvasPosition ), KRG_NVP( m_name ), KRG_NVP( m_exitEvents ), KRG_NVP( m_executeEvents ), KRG_NVP( m_ID ) );
    }
    ...
    {
        template<>
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::OffStateToolsNode> >( IRegisteredType const* pDefaultTypeInstance )
        {
            KRG_ASSERT( pDefaultTypeInstance != nullptr );
            KRG::Animation::Graph::OffStateToolsNode const* pActualDefaultTypeInstance = ( KRG::Animation::Graph::OffStateToolsNode const* ) pDefaultTypeInstance;
            ...
            propertyInfo.m_ID = StringID( "m_entryEvents" );
            propertyInfo.m_typeID = TypeSystem::TypeID( "KRG::StringID" );
            propertyInfo.m_parentTypeID = 3775123749;
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_entryEvents;
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::OffStateToolsNode, m_entryEvents );
            propertyInfo.m_pDefaultArrayData = pActualDefaultTypeInstance->m_entryEvents.data();
            propertyInfo.m_arraySize = (int32) pActualDefaultTypeInstance->m_entryEvents.size();
            propertyInfo.m_arrayElementSize = (int32) sizeof( KRG::StringID );
            propertyInfo.m_size = sizeof( TVector<KRG::StringID> );
            ...
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_canvasPosition;
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::OffStateToolsNode, m_canvasPosition );
            propertyInfo.m_size = sizeof( KRG::Float2 );
            propertyInfo.m_flags.Set( 0 );
            m_properties.emplace_back( propertyInfo );
            m_propertyMap.insert( TPair<StringID, int32>( propertyInfo.m_ID, int32( m_properties.size() ) - 1 ) );
            ...
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_name;
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::OffStateToolsNode, m_name );
            propertyInfo.m_size = sizeof( KRG::String );
            propertyInfo.m_flags.Set( 1 );
            m_properties.emplace_back( propertyInfo );
            m_propertyMap.insert( TPair<StringID, int32>( propertyInfo.m_ID, int32( m_properties.size() ) - 1 ) );
            ...
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_exitEvents;
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::OffStateToolsNode, m_exitEvents );
            propertyInfo.m_pDefaultArrayData = pActualDefaultTypeInstance->m_exitEvents.data();
            propertyInfo.m_arraySize = (int32) pActualDefaultTypeInstance->m_exitEvents.size();
            propertyInfo.m_arrayElementSize = (int32) sizeof( KRG::StringID );
            propertyInfo.m_size = sizeof( TVector<KRG::StringID> );
            ...
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_executeEvents;
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::OffStateToolsNode, m_executeEvents );
            propertyInfo.m_pDefaultArrayData = pActualDefaultTypeInstance->m_executeEvents.data();
            propertyInfo.m_arraySize = (int32) pActualDefaultTypeInstance->m_executeEvents.size();
            propertyInfo.m_arrayElementSize = (int32) sizeof( KRG::StringID );
            propertyInfo.m_size = sizeof( TVector<KRG::StringID> );
            ...
            propertyInfo.m_templateArgumentTypeID = TypeSystem::TypeID( "" );
            propertyInfo.m_pDefaultValue = &pActualDefaultTypeInstance->m_ID;
            propertyInfo.m_offset = offsetof( KRG::Animation::Graph::OffStateToolsNode, m_ID );
            propertyInfo.m_size = sizeof( KRG::UUID );
            propertyInfo.m_flags.Set( 0 );
            m_properties.emplace_back( propertyInfo );
            m_propertyMap.insert( TPair<StringID, int32>( propertyInfo.m_ID, int32( m_properties.size() ) - 1 ) );
        ...
        {
            template<>
            class KRG_TOOLS_ANIMATION_API TTypeHelper<KRG::Animation::Graph::OffStateToolsNode> final : public ITypeHelper
            {
                static TTypeHelper<KRG::Animation::Graph::OffStateToolsNode> StaticTypeHelper;
            ...
            public:
                ...
                {
                    IRegisteredType*& pDefaultTypeInstance = const_cast<IRegisteredType*&>( s_pDefaultTypeInstancePtr );
                    pDefaultTypeInstance = (IRegisteredType*) KRG::Alloc( sizeof( KRG::Animation::Graph::OffStateToolsNode ), alignof( KRG::Animation::Graph::OffStateToolsNode ) );
                    new ( pDefaultTypeInstance ) KRG::Animation::Graph::OffStateToolsNode;

                    TypeSystem::TypeInfo typeInfo;
                    typeInfo.m_ID = TypeSystem::TypeID( "KRG::Animation::Graph::OffStateToolsNode" );
                    typeInfo.m_size = sizeof( KRG::Animation::Graph::OffStateToolsNode );
                    typeInfo.m_alignment = alignof( KRG::Animation::Graph::OffStateToolsNode );
                    typeInfo.m_pTypeHelper = &StaticTypeHelper; 
                    ...
                    typeInfo.RegisterProperties< KRG::TypeSystem::TypeHelpers::TTypeHelper<KRG::Animation::Graph::OffStateToolsNode> >( s_pDefaultTypeInstancePtr );
                    KRG::Animation::Graph::OffStateToolsNode::s_pTypeInfo = typeRegistry.RegisterType( typeInfo );
                }

                static void UnregisterType( TypeSystem::TypeRegistry& typeRegistry )
                {
                    auto const ID = TypeSystem::TypeID( "KRG::Animation::Graph::OffStateToolsNode" );
                    typeRegistry.UnregisterType( ID );

                    IRegisteredType*& pDefaultTypeInstance = const_cast<IRegisteredType*&>( s_pDefaultTypeInstancePtr );
                    reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode*>( pDefaultTypeInstance )->~OffStateToolsNode();
                    KRG::Free( pDefaultTypeInstance );
                }

                virtual IRegisteredType* CreateType() const override final
                {
                    return KRG::New<KRG::Animation::Graph::OffStateToolsNode>();
                }

                virtual void CreateTypeInPlace( IRegisteredType* pAllocatedMemory ) const override final
                {
                    KRG_ASSERT( pAllocatedMemory != nullptr );
                    new( pAllocatedMemory ) KRG::Animation::Graph::OffStateToolsNode();
                }

                virtual void LoadResources( Resource::ResourceSystem* pResourceSystem, UUID const& requesterID, IRegisteredType* pType ) const override final
                {
                    KRG_ASSERT( pResourceSystem != nullptr );
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode*>( pType );
                ...
                virtual size_t GetArraySize( IRegisteredType const* pTypeInstance, uint32 arrayID ) const override final
                {
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode const*>( pTypeInstance );
                ...
                virtual void ClearArray( IRegisteredType* pTypeInstance, uint32 arrayID ) const override final
                {
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode*>( pTypeInstance );
                ...
                virtual bool AreAllPropertyValuesEqual( IRegisteredType const* pTypeInstance, IRegisteredType const* pOtherTypeInstance ) const override final
                {
                    auto pTypeHelper = KRG::Animation::Graph::OffStateToolsNode::s_pTypeInfo->m_pTypeHelper;
                    auto pType = reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode const*>( pTypeInstance );
                    auto pOtherType = reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode const*>( pOtherTypeInstance );
                ...
                virtual void ResetToDefault( IRegisteredType* pTypeInstance, uint32 propertyID ) override final
                {
                    auto pDefaultType = reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode const*>( GetDefaultTypeInstancePtr() );
                    auto pActualType = reinterpret_cast<KRG::Animation::Graph::OffStateToolsNode*>( pTypeInstance );
