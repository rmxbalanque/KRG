...
{
    void Tools_EntryStateOverrideConditionsNode::Update( TInlineVector<Tools_StateBaseNode*, 20> const& states )
    {
    ...
    void Tools_EntryStateOverrideGraph::Update( TInlineVector<Tools_StateBaseNode*, 20> const& states )
    {
