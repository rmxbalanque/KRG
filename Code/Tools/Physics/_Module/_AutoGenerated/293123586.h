...
#include "E:\Git\KRG\Code\Tools\Physics\ResourceDescriptors\ResourceDescriptor_PhysicsMesh.h"
...
namespace KRG
{
    ...
    {
        archive( cereal::base_class<KRG::Resource::ResourceDescriptor>( &type ), KRG_NVP( m_meshPath ), KRG_NVP( m_meshName ), KRG_NVP( m_isConvexMesh ) );
    }
    ...
    namespace TypeSystem
    {
        ...
        void TypeInfo::RegisterProperties< TypeSystem::TypeHelpers::TTypeHelper<KRG::Physics::PhysicsMeshResourceDescriptor> >( IRegisteredType const* pDefaultTypeInstance )
        {
            ...
            propertyInfo.m_offset = offsetof( KRG::Physics::PhysicsMeshResourceDescriptor, m_meshPath );
