#include "AnimationClipWorkspace.h"
...
namespace KRG::Animation
{
    ...
    void AnimationClipWorkspace::Activate( EntityWorld* pPreviewWorld )
    {
    ...
    void AnimationClipWorkspace::Deactivate( EntityWorld* pPreviewWorld )
    {
        KRG_ASSERT( m_pPreviewEntity != nullptr );
