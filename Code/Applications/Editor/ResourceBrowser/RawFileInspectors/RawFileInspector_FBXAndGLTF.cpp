#include "RawFileInspector_FBXAndGLTF.h"
...
namespace KRG
{
    KRG_RAW_FILE_INSPECTOR_FACTORY( InspectorFactoryFbx, "fbx", FileInspectorFBXAndGLTF );
    KRG_RAW_FILE_INSPECTOR_FACTORY( InspectorFactoryGltf, "gltf", FileInspectorFBXAndGLTF );
    KRG_RAW_FILE_INSPECTOR_FACTORY( InspectorFactoryGlb, "glb", FileInspectorFBXAndGLTF );

    //-------------------------------------------------------------------------

    FileInspectorFBXAndGLTF::FileInspectorFBXAndGLTF( EditorModel* pModel, FileSystem::Path const& filePath )
    ...
    bool FileInspectorFBXAndGLTF::DrawDialog()
    {
    ...
    void FileInspectorFBXAndGLTF::DrawStaticMeshControls( RawAssets::RawMeshInfo const& mesh )
    {
    ...
    void FileInspectorFBXAndGLTF::DrawSkeletalMeshControls( RawAssets::RawMeshInfo const& mesh )
    {
    ...
    void FileInspectorFBXAndGLTF::DrawSkeletonControls( RawAssets::RawSkeletonInfo const& skeleton )
    {
    ...
    void FileInspectorFBXAndGLTF::DrawAnimationControls( RawAssets::RawAnimationInfo const& animation )
    {
