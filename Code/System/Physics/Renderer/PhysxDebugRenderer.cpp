...
namespace KRG
{
    ...
    namespace Physics
    {
        ...
        void PhysicsRenderer::Render( Math::Viewport const& viewport )
        {
            ...
            auto debugFlags = PhysicsWorld::GetDebugFlags();
            if ( ( debugFlags && ( 1 << physx::PxVisualizationParameter::eSCALE ) ) == 0 )
            {
                return;
            }
            ...
            F32 const debugHalfDistance = ( PhysicsWorld::GetDebugDrawDistance() );
            ...
            auto pPhysicsScene = PhysicsWorld::GetScene();
