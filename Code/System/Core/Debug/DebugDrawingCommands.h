...
namespace KRG
{
    namespace Debug
    {
        namespace Drawing
        {
            ...
            {
                TriangleCommand( Float3 const& V0, Float3 const& V1, Float3 const& V2, Float4 const& color, DepthTestState state = DepthTestState::Off )
                    : m_vertex0( V0 )
                    , m_vertex1( V1 )
                    , m_vertex2( V2 )
                    , m_color0( color )
                ...
                TriangleCommand( Float3 const& V0, Float3 const& V1, Float3 const& V2, Float4 const& color0, Float4 const& color1, Float4 const& color2, DepthTestState state = DepthTestState::Off )
                    : m_vertex0( V0 )
                    , m_vertex1( V1 )
                    , m_vertex2( V2 )
                    , m_color0( color0 )
