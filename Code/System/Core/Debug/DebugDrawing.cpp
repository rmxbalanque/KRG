...
using namespace KRG::Debug::Drawing;
...
namespace KRG
{
    ...
    namespace Debug
    {
        ...
        void DrawingContext::DrawHalfSphere( Transform const& transform, Float4 const& color, float lineThickness, Drawing::DepthTestState depthTestState )
        {
            DrawCircle( transform, Axis::Z, color, lineThickness, depthTestState );
