    ...
    namespace Render
    {
        ...
        public:
            ...
            struct ResourceBinding
            {
                ...
                ResourceBinding( U32 ID, U32 slot ) : m_ID( ID ), m_slot( slot ) {}
        ...
        public:
            ...
            inline U32 GetNumConstBuffers() const { return (U32) m_cbuffers.size(); }
            inline RenderBuffer const& GetConstBuffer( U32 i ) const { KRG_ASSERT( i < m_cbuffers.size() ); return m_cbuffers[i]; }
        ...
        protected:
            ...
            Shader( PipelineStage stage, U8 const* pByteCode, size_t const byteCodeSize, TVector<RenderBuffer> const& constBuffers );

        protected:

            ResourceHandle                      m_shaderHandle;
            TVector<U8>                         m_byteCode;
        ...
        public:
            ...
            PixelShader( U8 const* pByteCode, size_t const byteCodeSize, TVector<RenderBuffer> const& constBuffers );
        ...
        public:
            ...
            GeometryShader( U8 const* pByteCode, size_t const byteCodeSize, TVector<RenderBuffer> const& constBuffers );
        ...
        public:
            ...
            VertexShader( U8 const* pByteCode, size_t const byteCodeSize, TVector<RenderBuffer> const& constBuffers, VertexLayoutDescriptor const& vertexLayoutDesc );
