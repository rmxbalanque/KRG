...
namespace KRG
{
    namespace ImGuiX
    {
        ...
        void System::InitializePlatform()
        {
        ...
        void System::UpdateDisplayInformation()
        {
            ImGuiIO& io = ImGui::GetIO();
        ...
        LRESULT System::ImguiWndProcess( HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam )
        {
            ImGuiIO& io = ImGui::GetIO();
            switch ( message )
            {
