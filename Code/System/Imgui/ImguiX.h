...
namespace KRG::ImGuiX
{
    ...
    KRG_SYSTEM_IMGUI_API ImVec2 const& GetClosestPointOnRect( ImRect const& rect, ImVec2 const& inPoint );
    ...
    KRG_SYSTEM_IMGUI_API void VerticalSeparator( ImVec2 const& size = ImVec2( 9, -1 ), ImColor const& color = 0 );

    // Draw an arrow between two points
    KRG_SYSTEM_IMGUI_API void DrawArrow( ImDrawList* pDrawList, ImVec2 const& arrowStart, ImVec2 const& arrowEnd, ImU32 col, float arrowWidth, float arrowHeadWidth = 5.0f );
}
#endif