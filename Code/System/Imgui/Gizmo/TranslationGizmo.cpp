...
namespace KRG
{
    namespace ImGuiX
    {
        ...
        bool TranslationGizmo::DrawPlaneTranslationWidget( Vector const& origin, Vector const& axis0, Vector const& axis1, Color color )
        {
            ...
            pDrawList->AddPolyline( drawQuadVerts, 4, ImGuiExtensions::GetImguiColorU32( color ), true, 1.0f );
            pDrawList->AddConvexPolyFilled( drawQuadVerts, 4, ImGuiExtensions::GetImguiColorU32( color.GetAlphaVersion( 0.75f ) ) );
        ...
        void TranslationGizmo::InternalUpdate( Render::Viewport const& viewport )
        {
            ...
            auto drawAxisGuide = [&pDrawList, this] ( Vector const& axis, Color color )
            {
                ...
                pDrawList->AddLine( lineStart.ToFloat2(), lineEnd.ToFloat2(), ImGuiExtensions::GetImguiColorU32( color ), g_axisGuideThickness );
            };
