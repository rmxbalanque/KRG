...
namespace KRG
{ 
    bool ConvertStringToBitFlags( TypeSystem::EnumInfo const& enumInfo, String const& str, BitFlags& outFlags )
    {
    ...
    bool ConvertBitFlagsToString( TypeSystem::EnumInfo const& enumInfo, BitFlags const& flags, String& outStr )
    {
        outStr.clear();
...
{
    {
        ...
        auto pEnumInfo = typeRegistry.GetEnumInfo( "KRG::SomeFlags" );
        ...
        BitFlags flagsA, flagsB, flagsC;
        bool ca = ConvertStringToBitFlags( *pEnumInfo, a, flagsA );
        bool cb = ConvertStringToBitFlags( *pEnumInfo, b, flagsB );
        bool cc = ConvertStringToBitFlags( *pEnumInfo, c, flagsC );

        String xa, xb, xc;

        bool da = ConvertBitFlagsToString( *pEnumInfo, flagsA, xa );
        std::cout << xa << std::endl;

        bool db = ConvertBitFlagsToString( *pEnumInfo, flagsB, xb );
        std::cout << xb << std::endl;

        bool dc = ConvertBitFlagsToString( *pEnumInfo, flagsC, xc );
